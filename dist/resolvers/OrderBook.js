...
const orderBookService = __importStar(require("../services/OrderBook"));
...
let OrderBookResolver = class OrderBookResolver {
    getOrderBook(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield orderBookService.getOrderBookById(id);
        });
    }
    getOrderBooks(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield orderBookService.getOrderBooks(args);
        });
    }
};
__decorate([
...
exports.OrderBookResolver = OrderBookResolver;
